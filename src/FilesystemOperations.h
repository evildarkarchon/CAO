...
public:
  ...
  /*!
   * \brief Compares if two folders have the same file structure. Currently only
   * used for testing.
  ...
  /*!
   * \brief Will copy all files from source folder into destination
   * folder.Currently only used for testing.
   * \param source The source directory
   * \param destination The destination directory
   * \param overwriteExisting If enabled, source files will overwrite
   * destination files
   */
