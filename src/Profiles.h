...
public:
  ...
  [[nodiscard]] static bool meshesEnabled() {
    return getInstance()._meshesEnabled;
  }
  [[nodiscard]] static nifly::NiFileVersion meshesFileVersion() {
    return getInstance()._meshesFileVersion;
  }
  [[nodiscard]] static uint meshesStream() {
    return getInstance()._meshesStream;
  }
  [[nodiscard]] static uint meshesUser() { return getInstance()._meshesUser; }

  [[nodiscard]] static bool animationsEnabled() {
    return getInstance()._animationsEnabled;
  }

  [[nodiscard]] static bool texturesEnabled() {
    return getInstance()._texturesEnabled;
  }
  [[nodiscard]] static DXGI_FORMAT texturesFormat() {
    return getInstance()._texturesFormat;
  }
  [[nodiscard]] static bool texturesConvertTga() {
    return getInstance()._texturesConvertTga;
  }
  ...
  [[nodiscard]] static QSettings *profileSettings() {
    return getInstance()._profileSettings;
  }
  [[nodiscard]] static QSettings *optionsSettings() {
    return getInstance()._optionsSettings;
  }
  [[nodiscard]] static QSettings *commonSettings() {
    return getInstance()._commonSettings;
  }
  [[nodiscard]] static QString logPath() { return getInstance()._logPath; }

  [[nodiscard]] static Profiles &getInstance();
  [[nodiscard]] static QString currentProfile() {
    return getInstance()._currentProfile;
  }
