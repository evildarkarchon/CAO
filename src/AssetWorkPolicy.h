...
public:
   ...
   * \return True when archive extraction was requested, the selected Profile
   * supports archives, and it has an archive extension.
   */
  [[nodiscard]] bool allowsArchiveExtraction() const;

  /*!
   * \brief Checks whether an archive should be extracted under this policy.
   * \param fileName The archive file name to compare against the Profile
   * archive extension.
   * \return True when archive extraction is allowed and the file name matches
   ...
   * \return True when archive packing was requested and the selected Profile
   * supports archives.
   */
   ...
   * \return True when texture work was requested and the selected Profile
   * supports textures.
   */
   ...
   * \return True when texture work was requested and the selected Profile
   * enables TGA conversion.
   */
  [[nodiscard]] bool allowsTgaTextureConversion() const;

  /*!
   * \brief Checks whether mesh Asset Work is allowed.
   * \return True when mesh work was requested and the selected Profile supports
   * meshes.
   */
   ...
   * \return True when animation work was requested and the selected Profile
   * supports animations.
   */
